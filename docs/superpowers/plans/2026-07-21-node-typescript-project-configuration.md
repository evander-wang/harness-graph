...
**Architecture:** `node-typescript-project-configuration` 继续使用标准 `workflow.yaml`、本地 Skill 和 Check。包管理器识别与命令适配收口在 `src/node-project/` 深 Module 中，CLI 只暴露 `project-check`；Workflow 和现有 Node.js 开发质量门禁共同调用它，不复制包管理器规则。
...
- Modify: `package.json`
- Modify: `harness/checks/node-typescript-quality-gate/CHECK.md`
- Create: `harness/checks/node-typescript-project-quality-gate/CHECK.md`
...
**Files:**
- Create: `harness/workflows/node-typescript-project-configuration/workflow.yaml`
- Create: `harness/models/node-typescript-project-configuration-request.schema.json`
- Create: `harness/models/node-typescript-project-profile.schema.json`
- Create: `harness/models/node-typescript-project-configuration-result.schema.json`
- Create: `skills/node-typescript-analyze-project/SKILL.md`
- Create: `skills/node-typescript-configure-project/SKILL.md`
- Create: `skills/node-typescript-configure-project/BASELINE.md`
- Create: `skills/node-typescript-verify-project/SKILL.md`
- Create: `skills/node-typescript-review-project-configuration/SKILL.md`
- Create: `skills/node-typescript-deliver-project-configuration/SKILL.md`
- Create: `harness/checks/node-typescript-project-plan-ready/CHECK.md`
- Create: `harness/checks/node-typescript-project-review-result/CHECK.md`
...
- Create: `harness/generated/node-typescript-project-configuration.svg`（命令生成）

- [ ] 执行 `npm run workflow:sync` 更新 Catalog。
- [ ] 执行 `npm run workflow:image -- harness/workflows/node-typescript-project-configuration/workflow.yaml` 生成 SVG。
